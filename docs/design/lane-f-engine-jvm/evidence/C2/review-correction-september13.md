# C2 independent-review correction batch â€” September 13
...
1. **R1 OPEN â€” asynchronous persistence failure.** Named test first: fail the effect
...
2. **R2 OPEN â€” launcher exclusion.** Acquire AppInstanceLock before operations open;
...
3. **R3 OPEN â€” transition refusal.** Re-read all ignored lifecycle booleans, reject
...
4. **R4 OPEN â€” audit/admission.** Audit NONE cannot bypass durable mutation acceptance;
...
5. **R5 OPEN â€” bounded history.** Add identity/checkpoint SQL bounds, inspect SQLite
...
6. **R6 OPEN â€” named crash test.** Halt a child JVM after acceptance before its first
...
7. **R7 OPEN â€” installed proof/status.** C2-11 must inspect operations and fail on
...
8. **R8 OPEN â€” swallowed failures.** Background terminalization, failed root walks,
...
9. **R9 OPEN â€” checklist/design reconciliation.** Reopen/reprove C2-1 schema16; name
...
10. **R10 OPEN â€” evidence/build/CI.** Generate and commit C2 raw-artifact SHA inventory
