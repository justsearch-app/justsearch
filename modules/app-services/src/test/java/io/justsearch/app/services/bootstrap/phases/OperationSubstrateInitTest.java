...
class OperationSubstrateInitTest {
  ...
  void run_returnsFullyPopulatedOutputAndRegistersNavigateHandler() {
    ...
    OperationSubstrateInit.Output out =
        OperationSubstrateInit.run(org.mockito.Mockito.mock(io.justsearch.app.api.operations.OperationStore.class), org.mockito.Mockito.mock(io.justsearch.app.api.operations.OperationAttemptRunner.class), org.mockito.Mockito.mock(io.justsearch.app.api.EngineAdmissionService.class), new io.justsearch.core.execution.TestEngineExecutors(),
            handlers,
            ops,
            agentTools,
            req -> true,
