...
public abstract class KnowledgeClient implements Closeable, SearchPort, IndexingService {
    ...
    @Override
    public io.justsearch.app.api.operations.CandidateIndexSelection captureCandidateIndexSelection(
        io.justsearch.configuration.resolved.ResolvedConfig candidate,
        EngineContext engineContext) {
        Objects.requireNonNull(candidate, "candidate");
        return executeIngestRpc("captureCandidateIndexSelection", RpcDeadlineCategory.LONG_RUNNING,
            service -> service.captureCandidateIndexSelection(candidate), engineContext);
    }
