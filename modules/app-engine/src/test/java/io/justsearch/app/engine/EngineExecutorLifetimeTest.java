...
class EngineExecutorLifetimeTest {
  ...
  void closingRestartableIndexHostDoesNotCloseProcessExecutors() throws Exception {
    ...
    var root = new EngineRoot(operations, org.mockito.Mockito.mock(io.justsearch.app.api.operations.OperationAttemptRunner.class), (ignored, ignoredExecutors, ignoredIngestion) -> { throw new AssertionError("No index startup expected"); },
        1_000, 16);
